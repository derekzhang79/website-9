                    ...
                    <div>
                        ...
                        <nav id="mainmenu_wrapper">
                            <ul id="mainmenu" class="nav sf-menu">
								...
								<li class="active" >
                                    <a href="a.php">Advisories Feed</a>
                                </li>
								<li  >
                                    <a href="viewAdvisories.php">View Advisories</a>
                                </li>
								<li  >
                                    <a href="n.php">News & Events Feed</a>
                                </li>
								<li >
                                    <a href="newsAndEvents.php"> View News & Events</a>
                                </li>
        ...
        <div class="row">           
            ...
            <div class="col-sm-4 to_animate" data-animation="fadeInBottom">
                ...
                <div class="teaser">
                    ...
                    <div class="teaser_description">
                        <h3> <span class="highlight">Add Header</span></h3>
                        <p>Add Advisories header items</p>
                        <p><a href="advisories_add_header.php" class="theme_button">Know More</a></p>
                    </div>
                </div>
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
                ...
                <div class="teaser">
                    ...
                    <div class="teaser_description">
                        <h3> <span class="highlight">Add Advisories</span></h3>
                        <p>Add Advisories items</p>
                        <p><a href="advisories_update.php" class="theme_button">Know More</a></p>
                    </div>
                </div>
            ...
            <div class="col-sm-4 to_animate" data-animation="fadeInRight">
                ...
                <div class="teaser">
                    ...
                    <div class="teaser_description">
                        <h3> <span class="highlight">Edit / Delete Advisories</span></h3>
                        <p>Edit / Delete Advisories header and advisories items </p>
                        <p><a href="advisory_edit_delete_header.php" class="theme_button">Know More</a></p>
                    </div>
                </div>
