...
<title>Add advisory Header</title>
    ...
    <div class="container">
        ...
        <div class="row">           
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				...
				<strong>Advisories header: </strong> <input type="text" id="firstname"name="firstname" value="<?php echo $first; ?>" /><br/>
				</div>
				<input type="submit" id="advisory-save-header" name="submit" value="Submit">
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				...
				<p class="advisory-add-header-message">                        
				<input type="hidden" >
				</p>	
...
mysql_query("INSERT advisoriesheader SET headers='$firstname'")
...
header("Location: advisory_view_headers.php");
