		...
		<div class="content" style="width: 900px !important;">
			...
			<form id="frmvalue" method="POST"  enctype="multipart/form-data" action="advisories_index.php"; >		
				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<select name="headerlist" id="headerlist"  >
							...
							<td>
								<p class="advisory-frmvalue-advisories-header-message">                        
								<input type="hidden" >
								</p>					
							</td>
					...
					<tr>				
						...
						<td>
							...
							<td>
								<p class="advisory-frmvalue-name--message">                        
								<input type="hidden" >
								</p>
							</td>
					...
					<tr>
						...
						<td>
							...
							<td>
								<p class="advisory-frmvalue-designation--message">                        
								<input type="hidden" >
								</p>
							</td>
					...
					<tr>
						...
						<td>
							<input type="text" aria-required="true" size="30" name="description" id="description"
							value="<?php echo (isset($gresult) ? $gresult["description"] :  '');?>" 
							class="txt-fld"/>
							
							
							<td>
								<p class="advisory-frmvalue-description--message">                        
								<input type="hidden" >
								</p>
							</td>
						</td>
						...
						<td>
						<input size="25" name="file" id="file" type="file" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10pt" class="box"/>
					     <label for="file" class="box"> <?php echo (isset($gresult) ? $gresult["image_path"] :  '');?></label>
							
							<td>
								<p class="advisory-frmvalue-image-message">                        
								<input type="hidden" >
								</p>
							</td>						
				...
				<input type="hidden" name="sn"
                                     value="<?php echo (isset($gresult) ? $gresult["s_no"] : '');  ?>" />
					<input class="btn" type="submit" name="save" id="advisories-save" value="SAVE" />
