    ...
    <div class="container">
        ...
        <div class="row">           
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				...
				<strong>Advisory header: </strong> <input type="text" id="firstname"name="firstname" value="<?php echo $firstname; ?>" /><br/>
				</div>
				<input type="submit" id="advisory-edit-header" name="submit" value="Update">
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				...
				<p class="advisory-edit-header-message">                        
				<input type="hidden" >
				</p>	
...
mysql_query("UPDATE advisoriesheader SET headers='$firstname' WHERE id='$id'")
...
header("Location: advisory_edit_delete_header.php");
...
$result = mysql_query("SELECT * FROM advisoriesheader WHERE id=$id")
