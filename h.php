                    ...
                    <div>
                        ...
                        <nav id="mainmenu_wrapper">
                            <ul id="mainmenu" class="nav sf-menu">
								...
								<li >
                                    <a href="viewAdvisories.php">Advisories Feed</a>
                                </li>
								<li  >
                                    <a href="newsAndEvents.php">News & Events Feed</a>
                                </li>
...
<section id="info" class="grey_section">
    <div class="container">
            ...
            <div class="col-sm-4 to_animate" data-animation="fadeInBottom">
                ...
                <div class="teaser">
                    <div class="teaser_icon">
                        <p><a href="advisories.php" class="theme_button">Advisories</a></p>
                    </div>
                    <div class="teaser_description">
                      
                        
                        <p><a href="news.php" class="theme_button">News & Events</a></p>
                    </div>
                </div>
