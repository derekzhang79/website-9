...
jQuery(document).ready(function() {
	...
	$("#year").blur(function(){
		...
		if(!isValid(year)){		
			if(fromYear[0] < 2000){
				$(".contact-form-year-message").text("Batch below 2000 year not allowed in XXXX").show();
				return false;				
			}
			else {
				$(".contact-form-year-message").hide();
		...
		if(fromYear[0] >= fullYear){
				$(".contact-form-year-message").text("Batch starting from 2000 only in XXXX").show();
				return false;				
			}
			else {
				$(".contact-form-year-message").hide();
	...
	if(fromYear[1] != ""){
			...
			if(fromYear[1] >= fullYear){
				$(".contact-form-year-message").text("Batch above current year not allowed in YYYY").show();
				return false;				
			}
			else {
				$(".contact-form-year-message").hide();
			...
			if(fromYear[1] < 2003){
				$(".contact-form-year-message").text("Batch below 2003 year not allowed in YYYY").show();
				return false;				
			}
			else {
				$(".contact-form-year-message").hide();
