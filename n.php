        ...
        <div class="row">
            ...
            <div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				<div class="teaser">
                    ...
                    <div class="teaser_description">
                        ...
                        <p>Add News & Events header items</p>
                        <p><a href="news_add_header.php" class="theme_button">Know More</a></p>
                    </div>
                </div>
            ...
            <div class="col-sm-4 to_animate" data-animation="fadeInBottom">
               ...
               <div class="teaser">
                    ...
                    <div class="teaser_description">
                        <h3> <span class="highlight">Add News & Events</span></h3>
                        <p>Add News & Events items</p>
                        <p><a href="news_update.php" class="theme_button">Know More</a></p>
                    </div>
                </div>
            ...
            <div class="col-sm-4 to_animate" data-animation="fadeInRight">
                ...
                <div class="teaser">
                    ...
                    <div class="teaser_description">
                        <h3> <span class="highlight">Edit / Delete News & Events</span></h3>
                        <p>Edit / Delete News & Events header and News & Events items</p>
                        <p><a href="news_edit_delete_header.php" class="theme_button">Know More</a></p>
                    </div>
                </div>
