...
$result = mysql_query("SELECT * FROM newsandeventsitemsheaders")
...
echo "<tr>  <th>News & Events  header</th>  <th>Edit Action</th> <th>Delete Action</th></tr>";
...
echo '<td><a href="news_edit_header.php?id=' . $row['id'] . '">Edit</a></td>';

echo '<td><a href="news_delete_header.php?id=' . $row['id'] . '">Delete</a></td>';
