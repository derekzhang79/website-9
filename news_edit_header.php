    ...
    <div class="container">
        ...
        <div class="row">           
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				...
				<strong>News & Events header: </strong> <input type="text" id="firstname"name="firstname" value="<?php echo $firstname; ?>" /><br/>
				</div>
				<input type="submit" id="news-edit-header" name="submit" value="Update">
